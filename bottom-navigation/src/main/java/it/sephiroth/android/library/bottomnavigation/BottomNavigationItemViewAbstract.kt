...
internal abstract class BottomNavigationItemViewAbstract(parent: BottomNavigation, expanded: Boolean,
    ...
    protected val colorActive: Int = menu.colorActive
    protected val colorInactive: Int = menu.colorInactive
    protected val colorDisabled: Int = menu.colorDisabled
    protected val rippleColor: Int = menu.rippleColor
    protected val animationDuration = menu.itemAnimationDuration.toLong()
